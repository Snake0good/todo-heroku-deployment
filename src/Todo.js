        ...
        <div className='block'>
            <div className='mt-2'>
                <label className='inline-flex items-center mt1 p-4 pb-4 hover:shadow-xl hover:bg-indigo-200 rounded-lg'>
                    <input type="checkbox" id="checkbox" checked={todo.complete} onChange={handleTodoClick} className="w-7 h-7 rounded-full border-2 border-pink-500 focus:ring-0 peer"/>
